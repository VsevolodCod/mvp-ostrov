              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <CardDescription className="flex items-center mt-2">
                    <Badge variant="outline" className="mr-2">{hotelData.type}</Badge>
                ...
                <Badge className={getUrgencyColor(hotelData.priority)}>
                  {hotelData.priority} приоритет
                </Badge>
              </div>
            </CardHeader>
            <CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center">
                  ...
                  <span className="text-sm">{hotelData.contact.phone}</span>
                </div>
                <div className="flex items-center">
                  <Mail className="w-4 h-4 text-gray-500 mr-2" />
                  <span className="text-sm">{hotelData.contact.email}</span>
                </div>
                <div className="flex items-center">
                  <Globe className="w-4 h-4 text-gray-500 mr-2" />
                  <span className="text-sm">{hotelData.contact.website}</span>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-6">
                    {hotelData.specialRequirements.map((category, index) => (
                      <div key={index}>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {hotelData.recentReports.map((report, index) => (
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardContent className="pt-6 space-y-3">
              ...
              <Button variant="outline" className="w-full" onClick={() => alert('Контакты отеля: ' + hotelData.contact.phone)}>
                Связаться с отелем
              </Button>
            </CardContent>
          </Card>
